...
#' @title write out LexisDB
#' @description This is a beta function.
#' @return function called for its side effects: some files written.
#' @export 
###############################################################################
writeLDB <- function(ldb.by.sex, 
  ...
  # TR 26 May, 2016: 
  # 1) use argument reproduce.matlab to toggle whether 
  # matlab style rounding is used. Default should be FALSE,
  # and TRUE only for testing. R uses an international standard
  # 2) use the same folder find/make code that you elsewhere in the LifeTable scripts.
  # 3) move the matlabrounding function to the utils.R file and document it...
  ...
  # TR: 26 May, 2016: 1) use reproduce.matlab to toggle this behavior.
  # 2) have a separate argument for whether and how much to round.
  if(strict){
