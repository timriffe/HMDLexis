...
setwd("/data/commons/boe/Triffe_git/HMDLexis/HMDLexis/")

## must modify Tim's dependence upon magrittr fluff routine
...
devtools::load_all("HMDLexis")  # devtools throws error if deprived of magrittr
library(data.table)
...
Pop.pre <- Pop
Pop      <- p_split(Pop.pre, Deaths, Births)
